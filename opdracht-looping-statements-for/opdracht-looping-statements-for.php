...
<body class="web-backend-opdracht">
    ...
    <section class="body">
        ...
        ?>
            ...
            echo '<table>';
            for ( $tafelTeller = 0; $tafelTeller <= $tafel; $tafelTeller++ ) 
            {
                echo '<tr>';
                    for( $productTeller = 1; $productTeller < $product; $productTeller++ ) 
                    { 
                        $uitkomst = $tafelTeller * $productTeller;
                        if(( $uitkomst ) % 2 > 0 ) 
                        { $even="class='oneven'"; } else { $even=''; }
                        echo "<td" . $even . ">" . $uitkomst . "</td>";
                    } 
                echo '</tr>';
