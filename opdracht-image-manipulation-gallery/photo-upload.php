<?php
	...
	$connection 	=	 new PDO( 'mysql:host=localhost;dbname=opdracht-image-manipulation', 'Indy', 'Indy' );
	...
	if ( isset( $_POST['submit'] ) )
	{
		...
		if ( $isType && $isSize && !$hasError )
		{
			...
			$galleryQuery	=	'INSERT INTO gallery ( file_name, title, caption)
								 VALUES ( :file_name, :title, :caption )';
			...
			echo 'INSERT INTO gallery ( file_name, title, caption)
